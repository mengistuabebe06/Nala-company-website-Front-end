...
export const CLIENT_CATEGORY_LIST_REQUEST = "CLIENT_CATEGORY_LIST_REQUEST";
export const CLIENT_CATEGORY_LIST_SUCCESS = "CLIENT_CATEGORY_LIST_SUCCESS";
export const CLIENT_CATEGORY_LIST_FAIL = "CLIENT_CATEGORY_LIST_FAIL";
