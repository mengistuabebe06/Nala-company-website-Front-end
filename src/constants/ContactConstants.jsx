...
export const CONTACT_CATEGORY_LIST_REQUEST = "CONTACT_CATEGORY_LIST_REQUEST";
export const CONTACT_CATEGORY_LIST_SUCCESS = "CONTACT_CATEGORY_LIST_SUCCESS";
export const CONTACT_CATEGORY_LIST_FAIL = "CONTACT_CATEGORY_LIST_FAIL";
