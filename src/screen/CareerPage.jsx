...
import { careerList } from "../action/careerAction";

export default function CareerPage() {
  const dispatch = useDispatch();
  const { loading, error, career } = useSelector((state) => state.CareerList);

  console.log("CareerList @ news page");
  // const handleSubmit = () => {
  //   createNews(news)
  // }
  console.log(career);
